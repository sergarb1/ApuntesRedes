...
- **NMS** (*Network Management System*): el gestor, el "centro de control". Ejemplos: Zabbix, PRTG, Nagios (los verás en detalle en el [punto 7](/ApuntesRedes/12-diagnostico-monitorizacion/07-herramientas-de-monitorizacion)).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/12-diagnostico-monitorizacion) · **Anterior:** [03 · Wireshark y análisis TCP](/ApuntesRedes/12-diagnostico-monitorizacion/03-wireshark) · **Siguiente:** [05 · Syslog y logging](/ApuntesRedes/12-diagnostico-monitorizacion/05-syslog-y-logging)