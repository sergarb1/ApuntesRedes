...
> 🗺️ **Estás en:** 🩺 U12 → 06 · NetFlow e IPFIX
...
SNMP (del [punto 4](/ApuntesRedes/12-diagnostico-monitorizacion/04-snmp)) te dice *cuánto* tráfico hay en una interfaz. NetFlow te dice *qué es* ese tráfico: qué IPs hablan entre sí, con qué protocolo y cuánto consumen. Es la diferencia entre saber que la autopista está llena y saber *qué coches la ocupan*.
...
- **Analizador:** el software que los grafica (Cisco NetFlow Analyzer, Elastic Stack, los dashboards de Zabbix o LibreNMS). Los verás en el [punto 7](/ApuntesRedes/12-diagnostico-monitorizacion/07-herramientas-de-monitorizacion).
...
2. **No**: NetFlow solo resume estadísticas (quién, puertos, bytes, tiempo). Esa es su ventaja: bajo coste y no expone datos sensibles. Capturar el contenido es trabajo de Wireshark, del [punto 3](/ApuntesRedes/12-diagnostico-monitorizacion/03-wireshark).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/12-diagnostico-monitorizacion) · **Anterior:** [05 · Syslog y logging](/ApuntesRedes/12-diagnostico-monitorizacion/05-syslog-y-logging) · **Siguiente:** [07 · Herramientas de monitorización](/ApuntesRedes/12-diagnostico-monitorizacion/07-herramientas-de-monitorizacion)