...
> 🗺️ **Estás en:** 🩺 U12 → 03 · Wireshark y análisis TCP

---

## 📬 La idea en una frase

> Wireshark es la **navaja suiza** del administrador: captura cada paquete que pasa por una interfaz, lo decodifica por protocolo y te permite ver con tus propios ojos lo que los comandos del [punto 2](/ApuntesRedes/12-diagnostico-monitorizacion/02-comandos-esenciales) solo insinúan.
...
El detalle de la captura —que se hace en el equipo o, con [port mirroring](/ApuntesRedes/12-diagnostico-monitorizacion/09-cierre), en el switch— es lo que convierte a Wireshark en la herramienta de diagnóstico definitiva.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/12-diagnostico-monitorizacion) · **Anterior:** [02 · Comandos esenciales](/ApuntesRedes/12-diagnostico-monitorizacion/02-comandos-esenciales) · **Siguiente:** [04 · SNMP](/ApuntesRedes/12-diagnostico-monitorizacion/04-snmp)