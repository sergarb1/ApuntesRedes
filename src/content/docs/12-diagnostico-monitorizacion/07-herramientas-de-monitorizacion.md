...
> 🗺️ **Estás en:** 🩺 U12 → 07 · Herramientas de monitorización

---

## 📬 La idea en una frase

> Las herramientas de monitorización son el **centro de control** donde confluyen todo lo que has aprendido: hacen **polling SNMP** (del [punto 4](/ApuntesRedes/12-diagnostico-monitorizacion/04-snmp)), reciben **syslog** (del [punto 5](/ApuntesRedes/12-diagnostico-monitorizacion/05-syslog-y-logging)) y analizan **NetFlow** (del [punto 6](/ApuntesRedes/12-diagnostico-monitorizacion/06-netflow-y-ipfix)), y lo pintan todo en gráficas y alarmas.
...
- **SNMP:** todas hacen polling a las OIDs de CPU, tráfico y memoria. Si configuraste el [punto 4](/ApuntesRedes/12-diagnostico-monitorizacion/04-snmp) con `publicia`, estas herramientas ya pueden leerte el router.
- **Syslog:** Zabbix y LibreNMS reciben logs centralizados; Nagios los procesa con plugins. Los mensajes del [punto 5](/ApuntesRedes/12-diagnostico-monitorizacion/05-syslog-y-logging) se convierten en eventos visibles.
- **NetFlow/IPFIX:** Zabbix y LibreNMS actúan como colector del [punto 6](/ApuntesRedes/12-diagnostico-monitorizacion/06-netflow-y-ipfix) y dibujan los *top talkers* en sus dashboards.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/12-diagnostico-monitorizacion) · **Anterior:** [06 · NetFlow e IPFIX](/ApuntesRedes/12-diagnostico-monitorizacion/06-netflow-y-ipfix) · **Siguiente:** [08 · Caso práctico de diagnóstico](/ApuntesRedes/12-diagnostico-monitorizacion/08-caso-practico-de-diagnostico)