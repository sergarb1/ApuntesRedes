...
Estas consecuencias no son "defectos": son el precio de compartir una IP pública entre cientos de equipos. Y de ellas salen los problemas que verás en el [punto 7](/ApuntesRedes/09-nat-pat/07-problemas-y-soluciones) y la discusión del [Fireside Chat del cierre](/ApuntesRedes/09-nat-pat/09-cierre).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/09-nat-pat) · **Anterior:** [Índice de la unidad](/ApuntesRedes/09-nat-pat) · **Siguiente:** [2 · Tipos de NAT](/ApuntesRedes/09-nat-pat/02-tipos-de-nat)