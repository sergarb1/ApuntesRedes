---
title: 6 — Tabla NAT y verificación
...
> ⚠️ **Síntoma clásico:** la tabla NAT vacía a pesar del tráfico. Suele significar que falta `ip nat inside` / `ip nat outside` en las interfaces, o que la access-list no coincide con la red. Es el fallo que protagoniza el [⚡ Laboratorio de tortura del cierre](/ApuntesRedes/09-nat-pat/09-cierre) y el boletín avanzado.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/09-nat-pat) · **Anterior:** [5 · NAT destino (port forwarding)](/ApuntesRedes/09-nat-pat/05-nat-destino) · **Siguiente:** [7 · Problemas y soluciones](/ApuntesRedes/09-nat-pat/07-problemas-y-soluciones)