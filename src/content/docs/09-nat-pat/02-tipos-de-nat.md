...
- [03 · NAT estático y dinámico](/ApuntesRedes/09-nat-pat/03-nat-estatico-y-dinamico) → el 1:1 fijo y el pool.
- [04 · PAT (sobrecarga)](/ApuntesRedes/09-nat-pat/04-pat) → la traducción con puertos.
- [05 · NAT destino (port forwarding)](/ApuntesRedes/09-nat-pat/05-nat-destino) → abrir puertos hacia dentro.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/09-nat-pat) · **Anterior:** [1 · ¿Qué es NAT?](/ApuntesRedes/09-nat-pat/01-que-es-nat) · **Siguiente:** [3 · NAT estático y dinámico](/ApuntesRedes/09-nat-pat/03-nat-estatico-y-dinamico)