...
> ⚠️ **Límite realista:** el número teórico de ~65.000 conexiones es solo eso: teórico. En el [Fireside del cierre](/ApuntesRedes/09-nat-pat/09-cierre) y en las [No hay preguntas tontas](/ApuntesRedes/09-nat-pat/09-cierre) lo matizamos.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/09-nat-pat) · **Anterior:** [3 · NAT estático y dinámico](/ApuntesRedes/09-nat-pat/03-nat-estatico-y-dinamico) · **Siguiente:** [5 · NAT destino (port forwarding)](/ApuntesRedes/09-nat-pat/05-nat-destino)