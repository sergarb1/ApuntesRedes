...
> 🗺️ **Estás en:** 🔌 **U03 · Infraestructura física** → 01 · Medios de transmisión
...
En la [U02](/ApuntesRedes/02-modelos-osi-analisis) viste que la capa 1 del modelo OSI se encarga de transmitir **bits**: series de 1 y 0 que, al final, tienen que atravesar algo físico. Ese "algo" es el medio de transmisión. Y como cada medio tiene sus reglas del juego, esta unidad entera consiste en conocerlas.
...
- **Límite de 100 metros**: la señal se atenúa con la distancia, y a partir de ahí los errores se disparan (lo verás en el [punto 7](/ApuntesRedes/03-infraestructura-fisica/07-conceptos-fisicos)).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/03-infraestructura-fisica) · **Anterior:** [Índice de la unidad](/ApuntesRedes/03-infraestructura-fisica) · **Siguiente:** [02 · El cable UTP](/ApuntesRedes/03-infraestructura-fisica/02-cable-utp)