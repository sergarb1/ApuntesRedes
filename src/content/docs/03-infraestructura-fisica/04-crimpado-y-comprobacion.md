...
> 🗺️ **Estás en:** 🔌 **U03 · Infraestructura física** → 04 · Crimpado y comprobación
...
En el [punto 3](/ApuntesRedes/03-infraestructura-fisica/03-directo-cruzado-consola) decidiste qué pinout usar. Aquí pasas a la acción: manos a la crimpadora.
...
> 🌡️ **El tester no mide todo:** un tester básico solo comprueba continuidad y orden. No detecta atenuación ni interferencias: para eso están los certificadores (caros, de empresa certificadora) y los [conceptos del punto 7](/ApuntesRedes/03-infraestructura-fisica/07-conceptos-fisicos).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/03-infraestructura-fisica) · **Anterior:** [03 · Directo, cruzado y consola](/ApuntesRedes/03-infraestructura-fisica/03-directo-cruzado-consola) · **Siguiente:** [05 · Fibra óptica](/ApuntesRedes/03-infraestructura-fisica/05-fibra-optica)