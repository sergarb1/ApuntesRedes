---
title: 5 — Máscaras y notación CIDR
...
> ⚠️ **Por qué "hosts útiles" ≠ "IPs totales":** de cada red, la primera dirección es la de **red** y la última el **broadcast**. Ninguna se asigna a un equipo. Por eso se restan 2 (en detalle en el [punto 6](/ApuntesRedes/03-direccionamiento-ip/06-subnetting-paso-a-paso)).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/03-direccionamiento-ip) · **Anterior:** [4 · IPs privadas y públicas](/ApuntesRedes/03-direccionamiento-ip/04-ip-privadas-y-publicas) · **Siguiente:** [6 · Subnetting paso a paso](/ApuntesRedes/03-direccionamiento-ip/06-subnetting-paso-a-paso)