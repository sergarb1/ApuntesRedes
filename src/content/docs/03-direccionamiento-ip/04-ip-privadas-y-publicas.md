---
title: 4 — IPs privadas y públicas
...
- **169.254.0.0/16 (APIPA):** tampoco es privado *asignable*: es el rango de emergencia que se ponen solos los hosts cuando no hay DHCP. Verás más en el [punto 8](/ApuntesRedes/03-direccionamiento-ip/08-dhcp).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/03-direccionamiento-ip) · **Anterior:** [3 · Clases de direcciones](/ApuntesRedes/03-direccionamiento-ip/03-clases-de-direcciones) · **Siguiente:** [5 · Máscaras y notación CIDR](/ApuntesRedes/03-direccionamiento-ip/05-mascaras-y-cidr)