...
📚 [Volver al índice de la unidad](/ApuntesRedes/03-direccionamiento-ip) · **Anterior:** [2 · Binario y la operación AND](/ApuntesRedes/03-direccionamiento-ip/02-binario-y-and) · **Siguiente:** [4 · IPs privadas y públicas](/ApuntesRedes/03-direccionamiento-ip/04-ip-privadas-y-publicas)