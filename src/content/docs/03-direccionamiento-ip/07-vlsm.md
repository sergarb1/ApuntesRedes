...
Recuerda la fórmula de hosts de cada máscara (la tienes en el [punto 5](/ApuntesRedes/03-direccionamiento-ip/05-mascaras-y-cidr)): `/25`=126, `/26`=62, `/27`=30, `/28`=14, `/29`=6, `/30`=2. Siempre se elige la máscara en la que **2ʰ − 2 ≥ hosts pedidos** con el menor desperdicio.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/03-direccionamiento-ip) · **Anterior:** [6 · Subnetting paso a paso](/ApuntesRedes/03-direccionamiento-ip/06-subnetting-paso-a-paso) · **Siguiente:** [8 · DHCP](/ApuntesRedes/03-direccionamiento-ip/08-dhcp)