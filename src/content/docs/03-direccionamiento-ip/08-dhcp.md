...
Con `ip dhcp excluded-address 192.168.1.1 192.168.1.10` apartas, por ejemplo, el router (.1), los servidores (.2-.9) y la impresora (.10) del reparto. Si DHCP entregara `192.168.1.1` —que ya es el gateway—, dos equipos acabarían con la misma IP y la semana sería muy larga. El [boletín avanzado](/ApuntesRedes/boletines/boletin-u03-avanzado) te propone precisamente ese escenario de conflicto.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/03-direccionamiento-ip) · **Anterior:** [7 · VLSM](/ApuntesRedes/03-direccionamiento-ip/07-vlsm) · **Siguiente:** [9 · Estructura de IPv6](/ApuntesRedes/03-direccionamiento-ip/09-estructura-ipv6)