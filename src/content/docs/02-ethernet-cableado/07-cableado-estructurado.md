...
|---|---|---|---|
| **Latiguillo (patch cord)** | Cable flexible de 1-5 m | Del PC al keystone y del patch panel al switch | Se compra hecho o se [crimpa](/ApuntesRedes/02-ethernet-cableado/04-crimpado-y-comprobacion); es la pieza que más se estropea |
