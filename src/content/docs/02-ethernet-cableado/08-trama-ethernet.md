...
> 🗺️ **Estás en:** 📡 **UD2 · Ethernet y cableado** → 8 · La trama Ethernet
...
Aquí leemos los campos de esas cabeceras como si fueran la ficha técnica del paquete: lo que luego verás desplegado en [Wireshark](/ApuntesRedes/01-introduccion/04-paquetes-y-protocolos).
...
IP dice "mándame esto a 192.168.1.20", pero Ethernet necesita una **MAC**. Ese traductor es **ARP** (*Address Resolution Protocol*), que ya viste en el [punto 8 de UD1](/ApuntesRedes/01-introduccion/01-que-es-una-red):
...
📚 [Volver al índice de la unidad](/ApuntesRedes/02-ethernet-cableado) · **Anterior:** [7 · Cableado estructurado](/ApuntesRedes/02-ethernet-cableado/07-cableado-estructurado) · **Siguiente:** [9 · Cierre: consolida lo aprendido](/ApuntesRedes/02-ethernet-cableado/09-cierre)