...
La tabla de colores depende de la **norma de crimpado** que uses al final del cable. Las dos normas que verás en el [punto 3](/ApuntesRedes/02-ethernet-cableado/03-directo-cruzado-consola) son T568A y T568B:
...
- **Interferencias fuertes** → Cat7/STP (apantallado) o, mejor, [fibra óptica](/ApuntesRedes/02-ethernet-cableado/05-fibra-optica).

> ⚠️ **No confundas categoría con calidad percibida:** un Cat6 mal crimpado (lo verás en el [punto 4](/ApuntesRedes/02-ethernet-cableado/04-crimpado-y-comprobacion)) rinde peor que un Cat5e perfecto. La categoría es el techo, no la garantía.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/02-ethernet-cableado) · **Anterior:** [1 · Medios de transmisión](/ApuntesRedes/02-ethernet-cableado/01-medios-de-transmision) · **Siguiente:** [3 · Directo, cruzado y consola](/ApuntesRedes/02-ethernet-cableado/03-directo-cruzado-consola)