...
En el [punto 1](/ApuntesRedes/02-ethernet-cableado/01-medios-de-transmision) viste la tabla que la presentaba como "cara y kilométrica". Aquí toca el detalle fino: por qué, y cuándo justifica su precio.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/02-ethernet-cableado) · **Anterior:** [4 · Crimpado y comprobación](/ApuntesRedes/02-ethernet-cableado/04-crimpado-y-comprobacion) · **Siguiente:** [6 · Conceptos físicos clave](/ApuntesRedes/02-ethernet-cableado/06-conceptos-fisicos)