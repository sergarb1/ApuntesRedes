---
title: U04 — Infraestructura física de red
description: El cable traicionero 🔌
---

<p><small>El cable traicionero 🔌</small></p>

> 🗺️ **El mapa del curso:** 📡 U03 → **🔌 AQUÍ ESTÁS (U04)** → 🧮 IPv4 → 🚀 IPv6 → 🔀 Switching → 🏢 VLAN → 🧭 Routing → 🗣️ OSPF → 🌐 NAT → 🩺 Diagnóstico → ☁️ Cloud
...
|---|---|---|
| [01 · Medios de transmisión](/ApuntesRedes/04-infraestructura-fisica/01-medios-de-transmision) | Cobre vs fibra vs aire: la tabla comparativa y cuándo elegir cada uno | Todos |
| [02 · El cable UTP](/ApuntesRedes/04-infraestructura-fisica/02-cable-utp) | 8 hilos, 4 pares, colores, trenzado y categorías | Todos |
| [03 · Directo, cruzado y consola](/ApuntesRedes/04-infraestructura-fisica/03-directo-cruzado-consola) | T568A vs T568B, qué conecta cada cable, Auto MDI-X, rollover | Todos |
| [04 · Crimpado y comprobación](/ApuntesRedes/04-infraestructura-fisica/04-crimpado-y-comprobacion) | Crimpar RJ45 paso a paso, tester y fallos típicos | Todos |
| [05 · Fibra óptica](/ApuntesRedes/04-infraestructura-fisica/05-fibra-optica) | Ventajas, monomodo vs multimodo, conectores y SFP | Todos |
...
| d) | Direccionamiento lógico IP | ✅ Introducción (se desarrolla en U05) |
...
- ¿Necesitas refrescar dónde vive la capa física y qué le pasa a un paquete antes de llegar al cable? → Repasa el [punto 1 del modelo OSI](/ApuntesRedes/03-modelos-osi-analisis/01-modelo-osi) de la U03, donde la capa 1 se encarga de los bits y los medios físicos.
- ¿Ya sabes lo básico? → Arranca directamente en el [punto 1](/ApuntesRedes/04-infraestructura-fisica/01-medios-de-transmision).

**📍 Primer punto:** [01 · Medios de transmisión](/ApuntesRedes/04-infraestructura-fisica/01-medios-de-transmision)  
**⏭️ Al acabar la unidad, continúa en [U05 · IPv4 y subnetting](/ApuntesRedes/05-ipv4-subnetting).**