...
Es la respuesta al ataque de CAM flooding del [punto 2](/ApuntesRedes/04-switching/02-aprendizaje-mac): si limitas las MACs por puerto, un atacante no puede llenar la tabla CAM ni conectar dispositivos no autorizados.
