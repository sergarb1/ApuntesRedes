...
> 🗺️ **Estás en:** 🌐 **U01 · Fundamentos de redes** → 07 · Direcciones MAC e IP
...
> En la U04 le daremos la vuelta de cabo a rabo (clases, CIDR, subnetting). Aquí solo presentamos el concepto.
...
Las IP privadas se traducen a IP públicas mediante **NAT** (lo verás a fondo en la U10). Por eso aunque millones de hogares usan `192.168.x.x`, en Internet cada uno sale con una IP pública distinta.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/01-fundamentos-redes) · **Anterior:** [06 · Protocolos](/ApuntesRedes/01-fundamentos-redes/06-protocolos) · **Siguiente:** [08 · Conectividad básica](/ApuntesRedes/01-fundamentos-redes/08-conectividad-basica)