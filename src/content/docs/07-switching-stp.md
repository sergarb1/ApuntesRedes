...
|---|---|---|
| [01 · ¿Qué es un switch?](/ApuntesRedes/07-switching-stp/01-que-es-un-switch) | Funcionamiento interno, capa 2, switch vs hub | Todos |
| [02 · Aprendizaje de MACs](/ApuntesRedes/07-switching-stp/02-aprendizaje-mac) | Tabla MAC, memoria CAM, flooding, `show mac address-table` | Todos |
| [03 · Dominios de colisión y broadcast](/ApuntesRedes/07-switching-stp/03-dominios-colision-broadcast) | Colisiones, broadcasts y quién los segmenta | Todos |
| [04 · La tormenta de broadcast](/ApuntesRedes/07-switching-stp/04-tormenta-de-broadcast) | Bucles, ARP infinito y colapso de la red | Todos |
| [05 · STP: fundamentos](/ApuntesRedes/07-switching-stp/05-stp-fundamentos) | IEEE 802.1D, BPDU, elección del Root Bridge | Todos |
| [06 · Puertos y estados STP](/ApuntesRedes/07-switching-stp/06-puertos-y-estados-stp) | Roles Root/Designated/Alternate y los estados | Todos |
| [07 · RSTP y PortFast](/ApuntesRedes/07-switching-stp/07-rstp-y-portfast) | Convergencia rápida, edge ports, BPDUGuard | Todos |
| [08 · Port Security](/ApuntesRedes/07-switching-stp/08-port-security) | Maximum, sticky MAC, violaciones y errdisable | Todos |
| [09 · Cierre](/ApuntesRedes/07-switching-stp/09-cierre) | Sé el Switch, Fireside, Laboratorio, Crucigrama… | Todos |
...
¿Ya has recorrido los 8 puntos de teoría y quieres la prueba de fuego? Cierra con el [punto 9 · Cierre](/ApuntesRedes/07-switching-stp/09-cierre) y después ataca los [boletines de la unidad](/ApuntesRedes/boletines/boletin-u08-inicial-resuelto). Y si lo que te falta es reforzar la base de dispositivos y capas, repasa el [punto 4 de dispositivos de la U02](/ApuntesRedes/02-fundamentos-redes/04-dispositivos).
