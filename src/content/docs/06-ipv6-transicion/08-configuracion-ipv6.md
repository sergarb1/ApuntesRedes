...
> 🗺️ **Estás en:** 🚀 **U06 · IPv6 y transición** → 08 · Configuración IPv6
...
> 💡 **Regla de diagnóstico:** si `show ipv6 interface brief` no muestra la dirección que configuraste en una interfaz, es que la config no "entró" o la interfaz está shutdown. Es exactamente el fallo del ⚡ Laboratorio del [punto 9](/ApuntesRedes/06-ipv6-transicion/09-cierre).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/06-ipv6-transicion) · **Anterior:** [07 · Mecanismos de transición](/ApuntesRedes/06-ipv6-transicion/07-mecanismos-de-transicion) · **Siguiente:** [09 · Cierre](/ApuntesRedes/06-ipv6-transicion/09-cierre)