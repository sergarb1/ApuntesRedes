...
> 🗺️ **Estás en:** 🚀 **U06 · IPv6 y transición** → 01 · Estructura de IPv6
...
- Los primeros 3 bits de una dirección GUA (Global Unicast) fijan su prefijo, pero de eso hablamos en el [punto 3](/ApuntesRedes/06-ipv6-transicion/03-tipos-de-direcciones).
...
- **Autoconfiguración sencilla:** con 64 bits reservados para el identificador de interfaz, el dispositivo puede generarse el final de su dirección solo (eso es EUI-64, [punto 4](/ApuntesRedes/06-ipv6-transicion/04-eui64-y-slaac)).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/06-ipv6-transicion) · **Anterior:** [Índice de la unidad](/ApuntesRedes/06-ipv6-transicion) · **Siguiente:** [02 · Compresión y prefijos](/ApuntesRedes/06-ipv6-transicion/02-compresion-y-prefijos)