...
> 🗺️ **Estás en:** 🚀 **U06 · IPv6 y transición** → 02 · Compresión y prefijos
...
- Los **64 bits inferiores** quedan reservados para el **identificador de interfaz**, que se construye con EUI-64 ([punto 4](/ApuntesRedes/06-ipv6-transicion/04-eui64-y-slaac)) y habilita **SLAAC** sin servidor central.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/06-ipv6-transicion) · **Anterior:** [01 · Estructura de IPv6](/ApuntesRedes/06-ipv6-transicion/01-estructura-ipv6) · **Siguiente:** [03 · Tipos de direcciones](/ApuntesRedes/06-ipv6-transicion/03-tipos-de-direcciones)