...
> 🗺️ **Estás en:** 🚀 **U06 · IPv6 y transición** → 05 · DHCPv6
...
Del [punto 4](/ApuntesRedes/06-ipv6-transicion/04-eui64-y-slaac) ya sabes que SLAAC puede dejar a un equipo *sin DNS*. Aquí está el complemento: DHCPv6.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/06-ipv6-transicion) · **Anterior:** [04 · EUI-64 y SLAAC](/ApuntesRedes/06-ipv6-transicion/04-eui64-y-slaac) · **Siguiente:** [06 · ICMPv6 y NDP](/ApuntesRedes/06-ipv6-transicion/06-icmpv6-y-ndp)