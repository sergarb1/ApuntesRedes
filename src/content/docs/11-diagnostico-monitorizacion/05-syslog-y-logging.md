...
> 🗺️ **Estás en:** 🩺 U11 → 05 · Syslog y logging
...
SNMP te dice el presente (del [punto 4](/ApuntesRedes/11-diagnostico-monitorizacion/04-snmp)); syslog te guarda el **pasado**. Cuando a las 3 de la madrugada un enlace se cae y se recupera, nadie está mirando, pero syslog lo tiene escrito con fecha y hora. Es la caja negra de la red.
...
Con esta config, cada router tiene su propio archivo de log. El siguiente paso natural es un **visor centralizado** (Kibana/Grafana o incluso la pestaña de logs de Zabbix) para buscar patrones: "¿cuántas veces se ha caído este enlace esta semana?" es una pregunta que solo tiene respuesta si tienes syslog montado. Lo verás combinado con las herramientas del [punto 7](/ApuntesRedes/11-diagnostico-monitorizacion/07-herramientas-de-monitorizacion).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/11-diagnostico-monitorizacion) · **Anterior:** [04 · SNMP](/ApuntesRedes/11-diagnostico-monitorizacion/04-snmp) · **Siguiente:** [06 · NetFlow e IPFIX](/ApuntesRedes/11-diagnostico-monitorizacion/06-netflow-y-ipfix)