...
> 🗺️ **Estás en:** 🩺 U11 → 02 · Comandos esenciales
...
Son los complementos del método del [punto 1](/ApuntesRedes/11-diagnostico-monitorizacion/01-metodologia-de-diagnostico): cada comando interroga a una capa del modelo OSI. Saber *qué pregunta hace cada uno* es tan importante como saber escribirlo.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/11-diagnostico-monitorizacion) · **Anterior:** [01 · Metodología de diagnóstico](/ApuntesRedes/11-diagnostico-monitorizacion/01-metodologia-de-diagnostico) · **Siguiente:** [03 · Wireshark y análisis TCP](/ApuntesRedes/11-diagnostico-monitorizacion/03-wireshark)