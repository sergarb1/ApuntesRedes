---
title: U03 — Modelos OSI y análisis de tráfico
description: El paquete perdido 🧳
---

<p><small>El paquete perdido 🧳</small></p>

> 🗺️ **El mapa del curso:** 🌐 U02 → **📡 AQUÍ ESTÁS (U03)** → 🔌 Físico → 🧮 IPv4 → 🚀 IPv6 → 🔀 Switching → 🏢 VLAN → 🧭 Routing → 🗣️ OSPF → 🌐 NAT → 🩺 Diagnóstico → ☁️ Cloud
...
|---|---|---|
| [01 · El modelo OSI](/ApuntesRedes/03-modelos-osi-analisis/01-modelo-osi) | Qué es, por qué 7 capas, PDU y regla de diagnóstico | Todos |
| [02 · Las 7 capas en detalle](/ApuntesRedes/03-modelos-osi-analisis/02-las-7-capas) | Capa por capa, protocolos y dispositivos | Todos |
| [03 · El modelo TCP/IP](/ApuntesRedes/03-modelos-osi-analisis/03-modelo-tcp-ip) | 4 capas, mapeo OSI ↔ TCP/IP, por qué manda en Internet | Todos |
| [04 · Encapsulación](/ApuntesRedes/03-modelos-osi-analisis/04-encapsulacion) | El viaje de los datos, PDU por capa, cabeceras reales | Todos |
| [05 · TCP y UDP](/ApuntesRedes/03-modelos-osi-analisis/05-tcp-y-udp) | Three-way handshake, flags, ventana, comparativa | Todos |
...
- ¿Necesitas refrescar capas y protocolos? → Repasa el [punto 5 del modelo OSI](/ApuntesRedes/02-fundamentos-redes/05-modelo-osi) y el [punto 6 de protocolos](/ApuntesRedes/02-fundamentos-redes/06-protocolos) de la U02.
- ¿Ya sabes lo básico? → Arranca directamente en el [punto 1](/ApuntesRedes/03-modelos-osi-analisis/01-modelo-osi).

**📍 Primer punto:** [01 · El modelo OSI](/ApuntesRedes/03-modelos-osi-analisis/01-modelo-osi)  
**⏭️ Al acabar la unidad, continúa en [U04 · Infraestructura física](/ApuntesRedes/04-infraestructura-fisica).**