...
> 🗺️ **Estás en:** 📡 **U02 · Modelos OSI y análisis** → 02 · Las 7 capas en detalle
...
En el [punto 1](/ApuntesRedes/02-modelos-osi-analisis/01-modelo-osi) viste el plano general. Ahora entramos a fondo: qué hace, qué protocolos usa y en qué dispositivos vive cada una de las 7 capas.
...
Dos protocolos estrella: **TCP** (fiable) y **UDP** (rápido). El detalle completo está en el [punto 5](/ApuntesRedes/02-modelos-osi-analisis/05-tcp-y-udp).
...
El protocolo estrella es **IP** en sus versiones 4 y 6 (las verás al detalle en [U04](/ApuntesRedes/04-ipv4-subnetting) y [U05](/ApuntesRedes/05-ipv6-transicion)).
...
Protocolos: **Ethernet** (cableado), **WiFi** (inalámbrico), **PPP** (punto a punto). Aquí trabaja el switch (lo viste en [U01](/ApuntesRedes/01-fundamentos-redes/04-dispositivos)).
...
> 💡 **Regla rápida de entrevista:** "un switch trabaja en capa 2, un router en capa 3, y un hub ni siquiera lee" — con eso respondes a un clásico de U01 que vuelve a salir aquí.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/02-modelos-osi-analisis) · **Anterior:** [01 · El modelo OSI](/ApuntesRedes/02-modelos-osi-analisis/01-modelo-osi) · **Siguiente:** [03 · El modelo TCP/IP](/ApuntesRedes/02-modelos-osi-analisis/03-modelo-tcp-ip)