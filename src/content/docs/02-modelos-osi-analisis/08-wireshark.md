...
> 🗺️ **Estás en:** 📡 **U02 · Modelos OSI y análisis** → 08 · Wireshark
...
> 💡 **Regla ocular:** si en una captura ves mucho rojo en la fila TCP, hay pérdidas → sospecha de congestión o enlaces saturados (control de flujo del [punto 5](/ApuntesRedes/02-modelos-osi-analisis/05-tcp-y-udp)).
