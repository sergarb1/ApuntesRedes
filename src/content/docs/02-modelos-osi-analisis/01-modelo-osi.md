...
> 🗺️ **Estás en:** 📡 **U02 · Modelos OSI y análisis** → 01 · El modelo OSI
...
Si esto te suena, es porque ya lo rozaste en el [punto 5 de la U01](/ApuntesRedes/01-fundamentos-redes/05-modelo-osi). Aquí lo llevamos al fondo.
...
Déjate el diagrama grabado: es el mapa que usarás en toda la unidad y en el [trabajo con Wireshark (punto 8)](/ApuntesRedes/02-modelos-osi-analisis/08-wireshark).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/02-modelos-osi-analisis) · **Anterior:** [Índice de la unidad](/ApuntesRedes/02-modelos-osi-analisis) · **Siguiente:** [02 · Las 7 capas en detalle](/ApuntesRedes/02-modelos-osi-analisis/02-las-7-capas)