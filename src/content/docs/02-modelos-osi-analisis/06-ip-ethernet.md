...
> 🗺️ **Estás en:** 📡 **U02 · Modelos OSI y análisis** → 06 · IP y Ethernet
...
Aquí leemos los campos de esas cabeceras como si fueran la ficha técnica del paquete: lo que luego verás desplegado en [Wireshark](/ApuntesRedes/02-modelos-osi-analisis/08-wireshark).
...
IP dice "mándame esto a 192.168.1.20", pero Ethernet necesita una **MAC**. Ese traductor es **ARP** (*Address Resolution Protocol*), que ya viste en el [punto 8 de U01](/ApuntesRedes/01-fundamentos-redes/08-conectividad-basica):
...
📚 [Volver al índice de la unidad](/ApuntesRedes/02-modelos-osi-analisis) · **Anterior:** [05 · TCP y UDP](/ApuntesRedes/02-modelos-osi-analisis/05-tcp-y-udp) · **Siguiente:** [07 · Puertos y sockets](/ApuntesRedes/02-modelos-osi-analisis/07-puertos-y-sockets)