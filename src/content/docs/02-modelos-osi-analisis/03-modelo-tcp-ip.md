...
> 🗺️ **Estás en:** 📡 **U02 · Modelos OSI y análisis** → 03 · El modelo TCP/IP
...
- Si hablas de **protocolos reales** (HTTP, TCP, IP, Ethernet): piensa en TCP/IP, porque sus nombres coinciden con las cabeceras que verás en [Wireshark](/ApuntesRedes/02-modelos-osi-analisis/08-wireshark).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/02-modelos-osi-analisis) · **Anterior:** [02 · Las 7 capas en detalle](/ApuntesRedes/02-modelos-osi-analisis/02-las-7-capas) · **Siguiente:** [04 · Encapsulación](/ApuntesRedes/02-modelos-osi-analisis/04-encapsulacion)