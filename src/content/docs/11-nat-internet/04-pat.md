...
> 🗺️ **Estás en:** 🌐 U11 → 04 · PAT (sobrecarga)
...
> ⚠️ **Límite realista:** el número teórico de ~65.000 conexiones es solo eso: teórico. En el [Fireside del cierre](/ApuntesRedes/11-nat-internet/09-cierre) y en las [No hay preguntas tontas](/ApuntesRedes/11-nat-internet/09-cierre) lo matizamos.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/11-nat-internet) · **Anterior:** [03 · NAT estático y dinámico](/ApuntesRedes/11-nat-internet/03-nat-estatico-y-dinamico) · **Siguiente:** [05 · NAT destino (port forwarding)](/ApuntesRedes/11-nat-internet/05-nat-destino)