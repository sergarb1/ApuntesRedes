...
Estas consecuencias no son "defectos": son el precio de compartir una IP pública entre cientos de equipos. Y de ellas salen los problemas que verás en el [punto 7](/ApuntesRedes/11-nat-internet/07-problemas-y-soluciones) y la discusión del [Fireside Chat del cierre](/ApuntesRedes/11-nat-internet/09-cierre).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/11-nat-internet) · **Anterior:** [Índice de la unidad](/ApuntesRedes/11-nat-internet) · **Siguiente:** [02 · Tipos de NAT](/ApuntesRedes/11-nat-internet/02-tipos-de-nat)