...
> 🗺️ **Estás en:** 🌐 U11 → 02 · Tipos de NAT
...
- [03 · NAT estático y dinámico](/ApuntesRedes/11-nat-internet/03-nat-estatico-y-dinamico) → el 1:1 fijo y el pool.
- [04 · PAT (sobrecarga)](/ApuntesRedes/11-nat-internet/04-pat) → la traducción con puertos.
- [05 · NAT destino (port forwarding)](/ApuntesRedes/11-nat-internet/05-nat-destino) → abrir puertos hacia dentro.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/11-nat-internet) · **Anterior:** [01 · ¿Qué es NAT?](/ApuntesRedes/11-nat-internet/01-que-es-nat) · **Siguiente:** [03 · NAT estático y dinámico](/ApuntesRedes/11-nat-internet/03-nat-estatico-y-dinamico)