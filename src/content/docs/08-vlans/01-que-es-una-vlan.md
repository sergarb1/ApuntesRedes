...
> 🗺️ **Estás en:** 🏢 **U08 · VLANs** → 01 · ¿Qué es una VLAN?
...
Varias marcas usan VLANs numeradas como estándar para evitar la VLAN 1 (Cisco recomienda reservarla y usar VLANs de datos como 10/20/30). Los detalles de hardening los verás en el [punto 7](/ApuntesRedes/08-vlans/07-seguridad-en-vlans).

---

## 🏷️ Los tipos de VLAN a vista de pájaro

Hay más de un tipo de VLAN y cada uno tiene un trabajo. Esta tabla es un adelanto; el [punto 2](/ApuntesRedes/08-vlans/02-tipos-de-vlan) la desarrolla:
...
📚 [Volver al índice de la unidad](/ApuntesRedes/08-vlans) · **Anterior:** [Índice de la unidad](/ApuntesRedes/08-vlans) · **Siguiente:** [02 · Tipos de VLAN](/ApuntesRedes/08-vlans/02-tipos-de-vlan)