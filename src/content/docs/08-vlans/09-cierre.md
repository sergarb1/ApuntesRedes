...
**PRÓXIMAMENTE EN U09:** Las VLANs separan la red por departamentos... y ahora toca decidir **quién puede cruzar** esas fronteras. En la U09 el routing entre redes y las **ACLs** se encargan de que no todo el mundo llegue a todo: configurarás el protocolo de rutas, filtraremos el tráfico y veremos cómo un router "educado" dice que no a los paquetes no deseados.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/08-vlans) · **Anterior:** [08 · Configuración y verificación](/ApuntesRedes/08-vlans/08-configuracion-y-verificacion) · **Siguiente:** **[U09 · Routing y ACLs](/ApuntesRedes/09-routing-acls)**