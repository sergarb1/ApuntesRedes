...
> 🗺️ **Estás en:** 🗣️ **U10 · Routing dinámico OSPF** → 03 · Conceptos OSPF
...
| **Área OSPF** | Subdivisión lógica para escalar (lo verás en el [punto 4](/ApuntesRedes/10-routing-dinamico/04-areas-y-tipos-de-routers)) |
...
Desde A, ¿cuál es la mejor ruta a D? **A → C → D** (5 + 1 = 6) frente a A → B → D (5 + 2 = 7). OSPF elige la de coste menor, no la de menos routers. El coste de cada enlace lo aprenderás en el [punto 6](/ApuntesRedes/10-routing-dinamico/06-coste-ospf).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/10-routing-dinamico) · **Anterior:** [02 · IGP vs EGP y RIP vs OSPF](/ApuntesRedes/10-routing-dinamico/02-igp-vs-egp) · **Siguiente:** [04 · Áreas y tipos de routers](/ApuntesRedes/10-routing-dinamico/04-areas-y-tipos-de-routers)