...
> 🗺️ **Estás en:** 🗣️ **U10 · Routing dinámico OSPF** → 08 · Ruta por defecto y diagnóstico
...
En la [U09](/ApuntesRedes/09-routing-acls) configuraste rutas por defecto con `ip route 0.0.0.0 0.0.0.0`. Ahora toca **compartirla con el resto de routers OSPF**. En el router que conecta con Internet (el borde, normalmente un ASBR):
...
- El segundo número `[110/2]` es el **coste** acumulado del camino: por eso `show ip route` también responde al [punto 6](/ApuntesRedes/10-routing-dinamico/06-coste-ospf).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/10-routing-dinamico) · **Anterior:** [07 · Configuración OSPF](/ApuntesRedes/10-routing-dinamico/07-configuracion-ospf) · **Siguiente:** [09 · Cierre](/ApuntesRedes/10-routing-dinamico/09-cierre)