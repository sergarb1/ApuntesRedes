...
> 🗺️ **Estás en:** 🗣️ **U10 · Routing dinámico OSPF** → 02 · IGP vs EGP y RIP vs OSPF
...
- **OSPF mira el ancho de banda** y calcula un **coste** por enlace (lo verás en el [punto 6](/ApuntesRedes/10-routing-dinamico/06-coste-ospf)): puede elegir una ruta con más saltos si es por fibra. Y como todos los routers de un área conocen la topología completa, convergen mucho más rápido.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/10-routing-dinamico) · **Anterior:** [01 · De estático a dinámico](/ApuntesRedes/10-routing-dinamico/01-de-estatico-a-dinamico) · **Siguiente:** [03 · Conceptos OSPF](/ApuntesRedes/10-routing-dinamico/03-conceptos-ospf)