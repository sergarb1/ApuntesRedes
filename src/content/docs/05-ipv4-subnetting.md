---
title: U05 — IPv4 y subnetting
description: La calculadora maldita 🧮
---

<p><small>La calculadora maldita 🧮</small></p>

> 🗺️ **El mapa del curso:** 🔌 U04 → **🧮 AQUÍ ESTÁS (U05)** → 🚀 IPv6 → 🔀 Switching → 🏢 VLAN → 🧭 Routing → 🗣️ OSPF → 🌐 NAT → 🩺 Diagnóstico → ☁️ Cloud
...
|---|---|---|
| [01 · Estructura de IPv4](/ApuntesRedes/05-ipv4-subnetting/01-estructura-ipv4) | 32 bits, 4 octetos, notación decimal punteada, IPs especiales | Todos |
| [02 · Binario y la operación AND](/ApuntesRedes/05-ipv4-subnetting/02-binario-y-and) | Pesos de bits, conversión, tabla rápida, AND bit a bit | Todos |
| [03 · Clases de direcciones](/ApuntesRedes/05-ipv4-subnetting/03-clases-de-direcciones) | Clases A-E y cómo CIDR las eliminó | Todos |
| [04 · IPs privadas y públicas](/ApuntesRedes/05-ipv4-subnetting/04-ip-privadas-y-publicas) | RFC 1918, NAT, agotamiento del espacio IPv4 | Todos |
| [05 · Máscaras y notación CIDR](/ApuntesRedes/05-ipv4-subnetting/05-mascaras-y-cidr) | Qué es la máscara, tabla completa /30 a /8 | Todos |
...
- ¿Necesitas refrescar dónde vive la capa IP en la pila y qué es un gateway? → Repasa el [punto 6 de la U03](/ApuntesRedes/03-modelos-osi-analisis/06-ip-ethernet).
- ¿Ya sabes lo básico? → Arranca directamente en el [punto 1](/ApuntesRedes/05-ipv4-subnetting/01-estructura-ipv4).

**📍 Primer punto:** [01 · Estructura de IPv4](/ApuntesRedes/05-ipv4-subnetting/01-estructura-ipv4)  
**⏭️ Al acabar la unidad, continúa en [U06 · IPv6 y transición](/ApuntesRedes/06-ipv6-transicion).**