...
> 🗺️ **Estás en:** 🧭 **U08 · Routing y ACLs** → 03 · Rutas estáticas
...
En el punto 2 dejaste al router con sus interfaces y su IP. Pero "tener interfaces" no es "saber llegar a las redes ajenas": el router solo conoce **directamente** las redes conectadas a sus puertos. Para el resto, o le enseñas tú (ruta estática) o que aprenda él (routing dinámico, U09). Aquí mandamos nosotros.
...
| **D / O / R** | Dinámicas (EIGRP/OSPF/RIP) | Protocolos de routing (U09) |
...
📚 [Volver al índice de la unidad](/ApuntesRedes/08-routing-acls) · **Anterior:** [02 · Configuración básica](/ApuntesRedes/08-routing-acls/02-configuracion-basica) · **Siguiente:** [04 · Ruta por defecto](/ApuntesRedes/08-routing-acls/04-ruta-por-defecto)