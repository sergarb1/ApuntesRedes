...
> 🗺️ **Estás en:** 🧭 **U08 · Routing y ACLs** → 05 · Cómo decide un router
...
📚 [Volver al índice de la unidad](/ApuntesRedes/08-routing-acls) · **Anterior:** [04 · Ruta por defecto](/ApuntesRedes/08-routing-acls/04-ruta-por-defecto) · **Siguiente:** [06 · ACLs: concepto y tipos](/ApuntesRedes/08-routing-acls/06-acls-conceptos)