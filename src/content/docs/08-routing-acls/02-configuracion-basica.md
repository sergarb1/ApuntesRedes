...
> 🗺️ **Estás en:** 🧭 **U08 · Routing y ACLs** → 02 · Configuración básica
...
📚 [Volver al índice de la unidad](/ApuntesRedes/08-routing-acls) · **Anterior:** [01 · Componentes del router](/ApuntesRedes/08-routing-acls/01-componentes-del-router) · **Siguiente:** [03 · Rutas estáticas](/ApuntesRedes/08-routing-acls/03-rutas-estaticas)