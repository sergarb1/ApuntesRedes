...
> 🗺️ **Estás en:** 🧭 **U08 · Routing y ACLs** → 06 · ACLs: concepto y tipos
...
📚 [Volver al índice de la unidad](/ApuntesRedes/08-routing-acls) · **Anterior:** [05 · Cómo decide un router](/ApuntesRedes/08-routing-acls/05-como-decide-el-router) · **Siguiente:** [07 · ACL estándar](/ApuntesRedes/08-routing-acls/07-acl-estandar)