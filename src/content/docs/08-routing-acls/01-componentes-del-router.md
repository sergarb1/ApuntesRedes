...
> 🗺️ **Estás en:** 🧭 **U08 · Routing y ACLs** → 01 · Componentes del router
...
A simple vista es una caja con LEDs parpadeantes. Por dentro es un mini-PC con una misión: **leer la dirección IP destino de cada paquete, consultar su tabla de rutas y reenviarlo** por la interfaz correcta. En la U07 tu switch aprendía MACs; el router, en cambio, trabaja en capa 3.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/08-routing-acls) · **Anterior:** [Índice de la unidad](/ApuntesRedes/08-routing-acls) · **Siguiente:** [02 · Configuración básica](/ApuntesRedes/08-routing-acls/02-configuracion-basica)