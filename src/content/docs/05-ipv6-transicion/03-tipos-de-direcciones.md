...
> 🗺️ **Estás en:** 🚀 **U05 · IPv6 y transición** → 03 · Tipos de direcciones
...
| `FF02::1:FFxx:xxxx` | **Solicited-node multicast**: grupo derivado de la propia IP, usado por NDP ([punto 6](/ApuntesRedes/05-ipv6-transicion/06-icmpv6-y-ndp)) |
...
📚 [Volver al índice de la unidad](/ApuntesRedes/05-ipv6-transicion) · **Anterior:** [02 · Compresión y prefijos](/ApuntesRedes/05-ipv6-transicion/02-compresion-y-prefijos) · **Siguiente:** [04 · EUI-64 y SLAAC](/ApuntesRedes/05-ipv6-transicion/04-eui64-y-slaac)