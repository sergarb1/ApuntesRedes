...
> 🗺️ **Estás en:** 🚀 **U05 · IPv6 y transición** → 07 · Mecanismos de transición
...
- **NAT64** traduce el tráfico real: IPv6→IPv4 hacia fuera y la respuesta IPv4→IPv6 hacia dentro. Es el *NAT inverso* de la U10.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/05-ipv6-transicion) · **Anterior:** [06 · ICMPv6 y NDP](/ApuntesRedes/05-ipv6-transicion/06-icmpv6-y-ndp) · **Siguiente:** [08 · Configuración IPv6](/ApuntesRedes/05-ipv6-transicion/08-configuracion-ipv6)