...
> 🗺️ **Estás en:** 🚀 **U05 · IPv6 y transición** → 04 · EUI-64 y SLAAC
...
2. El router responde con un **RA (Router Advertisement)** que incluye el prefijo de red (`2001:DB8:1:2::/64`), los flags M y O ([punto 5](/ApuntesRedes/05-ipv6-transicion/05-dhcpv6)) y otros parámetros.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/05-ipv6-transicion) · **Anterior:** [03 · Tipos de direcciones](/ApuntesRedes/05-ipv6-transicion/03-tipos-de-direcciones) · **Siguiente:** [05 · DHCPv6](/ApuntesRedes/05-ipv6-transicion/05-dhcpv6)