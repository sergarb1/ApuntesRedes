...
> 🗺️ **Estás en:** 🌐 **U02 · Fundamentos de redes** → 09 · Cierre
...
3. El problema real es que las **VLANs son diferentes**: los equipos están físicamente conectados pero lógicamente separados. *Esto se estudia en la U08; hoy solo sufre (digo: aprende).*
...
| 🏅 **Topología Pro** | Dibujar de memoria las 4 topologías vistas en [03](/ApuntesRedes/02-fundamentos-redes/03-topologias) |
...
**PRÓXIMAMENTE EN U03:** Encapsulación, PDUs y el arte de leer tramas con Wireshark. 📦

---

📚 [Volver al índice de la unidad](/ApuntesRedes/02-fundamentos-redes) · **Anterior:** [08 · Conectividad básica](/ApuntesRedes/02-fundamentos-redes/08-conectividad-basica) · **Siguiente:** **[U03 · Modelos OSI y análisis](/ApuntesRedes/03-modelos-osi-analisis)**