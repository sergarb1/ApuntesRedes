...
> 🗺️ **Estás en:** 🌐 **U02 · Fundamentos de redes** → 02 · Tipos de red y alcance
...
Cuando hablamos de "medio de transmisión" nos referimos al canal físico por donde viajan los datos: cable de cobre trenzado (UTP), **fibra óptica** (pulsos de luz) u **ondas electromagnéticas** (WiFi, 5G, satélite). En la U04 los estudiaremos a fondo:
...
El único punto donde tu LAN toca el mundo es el **router**: ahí acabas tú y empieza la red del operador. Por eso, cuando "no hay Internet", primero decides si el fallo está en tu LAN (pasos vistos en [08](/ApuntesRedes/02-fundamentos-redes/08-conectividad-basica)) o en el enlace contratado.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/02-fundamentos-redes) · **Anterior:** [01 · ¿Qué es una red?](/ApuntesRedes/02-fundamentos-redes/01-que-es-una-red) · **Siguiente:** [03 · Topologías](/ApuntesRedes/02-fundamentos-redes/03-topologias)