...
> 🗺️ **Estás en:** 🌐 **U02 · Fundamentos de redes** → 01 · ¿Qué es una red?
...
> 💡 **Detalle práctico:** con un solo switch, el aula es una LAN en topología estrella. Si el centro une todas las aulas con un switch central, tendrás un **árbol** (lo vemos en el [punto 3](/ApuntesRedes/02-fundamentos-redes/03-topologias)).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/02-fundamentos-redes) · **Anterior:** [Unidad 01](/ApuntesRedes/01-introduccion) · **Siguiente:** [02 · Tipos de red y alcance](/ApuntesRedes/02-fundamentos-redes/02-tipos-y-alcance)