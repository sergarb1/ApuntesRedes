...
> 🗺️ **Estás en:** 🧮 **U04 · IPv4 y subnetting** → 07 · VLSM
...
Recuerda la fórmula de hosts de cada máscara (la tienes en el [punto 5](/ApuntesRedes/04-ipv4-subnetting/05-mascaras-y-cidr)): `/25`=126, `/26`=62, `/27`=30, `/28`=14, `/29`=6, `/30`=2. Siempre se elige la máscara en la que **2ʰ − 2 ≥ hosts pedidos** con el menor desperdicio.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/04-ipv4-subnetting) · **Anterior:** [06 · Subnetting paso a paso](/ApuntesRedes/04-ipv4-subnetting/06-subnetting-paso-a-paso) · **Siguiente:** [08 · DHCP](/ApuntesRedes/04-ipv4-subnetting/08-dhcp)