...
> 🗺️ **Estás en:** 🧮 **U04 · IPv4 y subnetting** → 05 · Máscaras y notación CIDR
...
> ⚠️ **Por qué "hosts útiles" ≠ "IPs totales":** de cada red, la primera dirección es la de **red** y la última el **broadcast**. Ninguna se asigna a un equipo. Por eso se restan 2 (en detalle en el [punto 6](/ApuntesRedes/04-ipv4-subnetting/06-subnetting-paso-a-paso)).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/04-ipv4-subnetting) · **Anterior:** [04 · IPs privadas y públicas](/ApuntesRedes/04-ipv4-subnetting/04-ip-privadas-y-publicas) · **Siguiente:** [06 · Subnetting paso a paso](/ApuntesRedes/04-ipv4-subnetting/06-subnetting-paso-a-paso)