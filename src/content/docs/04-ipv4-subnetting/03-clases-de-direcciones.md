...
> 🗺️ **Estás en:** 🧮 **U04 · IPv4 y subnetting** → 03 · Clases de direcciones
...
- **D** no se usa para equipos: es la reserva del **multicast** (envío de "uno a muchos dentro de un grupo"). Ahí viven OSPF y otros protocolos que verás en la U09.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/04-ipv4-subnetting) · **Anterior:** [02 · Binario y la operación AND](/ApuntesRedes/04-ipv4-subnetting/02-binario-y-and) · **Siguiente:** [04 · IPs privadas y públicas](/ApuntesRedes/04-ipv4-subnetting/04-ip-privadas-y-publicas)