...
> 🗺️ **Estás en:** 🧮 **U04 · IPv4 y subnetting** → 04 · IPs privadas y públicas
...
- Y cuando un equipo de dentro necesita salir a Internet, el router hace **NAT** y le presta una IP pública a la vez (lo verás en el [punto de NAT de la U10](/ApuntesRedes/10-nat-y-gateway)).
...
- **NAT (U10):** el router convierte la IP privada de la LAN en su IP pública para salir. Un solo `83.45.12.78` de la oficina puede sostener cientos de PCs internos con IPs privadas distintas.
...
- **IPv6 (U05):** con 128 bits, cada dispositivo puede tener una dirección pública *de verdad* sin NAT. Las privadas son un apaño brillante... pero un apaño al fin y al cabo.
...
- **169.254.0.0/16 (APIPA):** tampoco es privado *asignable*: es el rango de emergencia que se ponen solos los hosts cuando no hay DHCP. Verás más en el [punto 8](/ApuntesRedes/04-ipv4-subnetting/08-dhcp).
...
| NAT | Traducción de IP privada a pública al salir (U10) |

---

📚 [Volver al índice de la unidad](/ApuntesRedes/04-ipv4-subnetting) · **Anterior:** [03 · Clases de direcciones](/ApuntesRedes/04-ipv4-subnetting/03-clases-de-direcciones) · **Siguiente:** [05 · Máscaras y notación CIDR](/ApuntesRedes/04-ipv4-subnetting/05-mascaras-y-cidr)