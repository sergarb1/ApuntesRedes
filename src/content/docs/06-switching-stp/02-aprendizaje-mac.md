...
> 🗺️ **Estás en:** 🔀 U06 → 02 · Aprendizaje de MACs
...
📚 [Volver al índice de la unidad](/ApuntesRedes/06-switching-stp) · **Anterior:** [01 · ¿Qué es un switch?](/ApuntesRedes/06-switching-stp/01-que-es-un-switch) · **Siguiente:** [03 · Dominios de colisión y broadcast](/ApuntesRedes/06-switching-stp/03-dominios-colision-broadcast)