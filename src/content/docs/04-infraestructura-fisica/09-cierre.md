...
**PRÓXIMAMENTE EN U05:** Direccionamiento IPv4, subredes, máscaras y por qué 192.168.1.256 no existe. Ahora que los bits ya viajan por un buen cable, toca darles una dirección que no se pierda.
...
| d) | Direccionamiento lógico IP | ✅ (Introducción — se verá en U05) |
| e) | Estándares inalámbricos | ✅ WiFi 4/5/6/7 (punto 6) |
| f) | Integración de dispositivos | ✅ Cableado estructurado (punto 8) |

---

📚 [Volver al índice de la unidad](/ApuntesRedes/04-infraestructura-fisica) · **Anterior:** [08 · Cableado estructurado](/ApuntesRedes/04-infraestructura-fisica/08-cableado-estructurado) · **Siguiente:** **[U05 · IPv4 y subnetting](/ApuntesRedes/05-ipv4-subnetting)**