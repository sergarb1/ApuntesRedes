...
> 🗺️ **Estás en:** 🔌 **U04 · Infraestructura física** → 08 · Cableado estructurado
...
Es el broche de la unidad: los conceptos físicos del [punto 7](/ApuntesRedes/04-infraestructura-fisica/07-conceptos-fisicos) y la anatomía del [punto 2](/ApuntesRedes/04-infraestructura-fisica/02-cable-utp) se juntan aquí en un sistema pensado para durar y mantenerse.
...
|---|---|---|---|
| **Latiguillo (patch cord)** | Cable flexible de 1-5 m | Del PC al keystone y del patch panel al switch | Se compra hecho o se [crimpa](/ApuntesRedes/04-infraestructura-fisica/04-crimpado-y-comprobacion); es la pieza que más se estropea |
...
📚 [Volver al índice de la unidad](/ApuntesRedes/04-infraestructura-fisica) · **Anterior:** [07 · Conceptos físicos clave](/ApuntesRedes/04-infraestructura-fisica/07-conceptos-fisicos) · **Siguiente:** [09 · Cierre: consolida lo aprendido](/ApuntesRedes/04-infraestructura-fisica/09-cierre)