...
> 🗺️ **Estás en:** 🔌 **U04 · Infraestructura física** → 07 · Conceptos físicos clave
...
Estos conceptos son el puente entre la teoría y los [fallos del punto 4](/ApuntesRedes/04-infraestructura-fisica/04-crimpado-y-comprobacion) y el [cableado del edificio](/ApuntesRedes/04-infraestructura-fisica/08-cableado-estructurado). Si los dominas, todo lo demás encaja.
...
Interferencia de un par de hilos sobre otro par adyacente. Como viste con el [trenzado del punto 2](/ApuntesRedes/04-infraestructura-fisica/02-cable-utp), los pares se influyen entre sí. Los tipos que cita la normativa:
...
📚 [Volver al índice de la unidad](/ApuntesRedes/04-infraestructura-fisica) · **Anterior:** [06 · WiFi](/ApuntesRedes/04-infraestructura-fisica/06-wifi) · **Siguiente:** [08 · Cableado estructurado](/ApuntesRedes/04-infraestructura-fisica/08-cableado-estructurado)