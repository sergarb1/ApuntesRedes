---
title: U06 — IPv6 y transición
description: El futuro que ya llegó 🚀
---

<p><small>El futuro que ya llegó 🚀</small></p>

> 🗺️ **El mapa del curso:** 🧮 U05 → **🚀 AQUÍ ESTÁS (U06)** → 🔀 Switching → 🏢 VLAN → 🧭 Routing → 🗣️ OSPF → 🌐 NAT → 🩺 Diagnóstico → ☁️ Cloud
...
|---|---|---|
| [01 · Estructura de IPv6](/ApuntesRedes/06-ipv6-transicion/01-estructura-ipv6) | Por qué IPv6, 128 bits, 8 grupos hexadecimales | Todos |
| [02 · Compresión y prefijos](/ApuntesRedes/06-ipv6-transicion/02-compresion-y-prefijos) | Ceros a la izquierda, el `::`, prefijos /32 /48 /64 | Todos |
| [03 · Tipos de direcciones](/ApuntesRedes/06-ipv6-transicion/03-tipos-de-direcciones) | Unicast (GUA, LLA, ULA, loopback), multicast, anycast | Todos |
| [04 · EUI-64 y SLAAC](/ApuntesRedes/06-ipv6-transicion/04-eui64-y-slaac) | De la MAC a la interfaz, autoconfiguración plug-and-play | Todos |
| [05 · DHCPv6](/ApuntesRedes/06-ipv6-transicion/05-dhcpv6) | Stateless vs stateful, flags M y O del RA | Todos |
...
- ¿Necesitas refrescar IPv4, subnetting y NAT? → Repasa el [subnetting de la U05](/ApuntesRedes/05-ipv4-subnetting) y el [NAT de la U11](/ApuntesRedes/11-nat-internet). IPv6 se entiende mejor cuando has vivido la escasez.
- ¿Ya sabes lo básico? → Arranca directamente en el [punto 1](/ApuntesRedes/06-ipv6-transicion/01-estructura-ipv6).

**📍 Primer punto:** [01 · Estructura de IPv6](/ApuntesRedes/06-ipv6-transicion/01-estructura-ipv6)  
**⏭️ Al acabar la unidad, continúa en [U07 · Switching y STP](/ApuntesRedes/07-switching-stp).**