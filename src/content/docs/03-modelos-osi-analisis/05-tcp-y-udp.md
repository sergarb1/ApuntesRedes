...
> 🗺️ **Estás en:** 📡 **U03 · Modelos OSI y análisis** → 05 · TCP y UDP
...
En [U02](/ApuntesRedes/02-fundamentos-redes/06-protocolos) viste el resumen con el árbol de decisión. Aquí entramos en la maquinaria: handshake, flags, ventana deslizante y la tabla comparativa definitiva.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/03-modelos-osi-analisis) · **Anterior:** [04 · Encapsulación](/ApuntesRedes/03-modelos-osi-analisis/04-encapsulacion) · **Siguiente:** [06 · IP y Ethernet](/ApuntesRedes/03-modelos-osi-analisis/06-ip-ethernet)