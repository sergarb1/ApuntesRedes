...
> 🗺️ **Estás en:** 📡 **U03 · Modelos OSI y análisis** → 04 · Encapsulación
...
La muñeca rusa de la que hablábamos en el [punto 1](/ApuntesRedes/03-modelos-osi-analisis/01-modelo-osi), ahora en movimiento.
...
Para que esto no sea teoría vacía, estos son los tamaños que verás reflejados en [Wireshark](/ApuntesRedes/03-modelos-osi-analisis/08-wireshark):
...
📚 [Volver al índice de la unidad](/ApuntesRedes/03-modelos-osi-analisis) · **Anterior:** [03 · El modelo TCP/IP](/ApuntesRedes/03-modelos-osi-analisis/03-modelo-tcp-ip) · **Siguiente:** [05 · TCP y UDP](/ApuntesRedes/03-modelos-osi-analisis/05-tcp-y-udp)