---
title: 4 — Áreas y tipos de routers
...
> ⚠️ **Por qué esta regla:** OSPF usa el Área 0 como punto de no retorno para evitar **bucles de routing inter-área**. Es la misma lógica de "todas las rutas pasan por el centro": con un único punto de entrada/salida, no hay caminos cruzados que se pisen. El fallo intencionado del [laboratorio de la unidad](/ApuntesRedes/07-ospf/09-cierre) explota exactamente esto: dos áreas conectadas entre sí sin pasar por el Área 0 **no se comunican**.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/07-ospf) · **Anterior:** [3 · Conceptos OSPF](/ApuntesRedes/07-ospf/03-conceptos-ospf) · **Siguiente:** [5 · DR y BDR](/ApuntesRedes/07-ospf/05-dr-y-bdr)