---
title: 8 — Ruta por defecto y diagnóstico
...
- El segundo número `[110/2]` es el **coste** acumulado del camino: por eso `show ip route` también responde al [punto 6](/ApuntesRedes/07-ospf/06-coste-ospf).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/07-ospf) · **Anterior:** [7 · Configuración OSPF](/ApuntesRedes/07-ospf/07-configuracion-ospf) · **Siguiente:** [9 · Cierre: consolida lo aprendido](/ApuntesRedes/07-ospf/09-cierre)