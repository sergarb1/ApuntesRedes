...
En `show ip ospf neighbor` (lo usarás en el [punto 7](/ApuntesRedes/07-ospf/07-configuracion-ospf) y en los boletines) verás dos estados que hay que saber leer:
...
📚 [Volver al índice de la unidad](/ApuntesRedes/07-ospf) · **Anterior:** [4 · Áreas y tipos de routers](/ApuntesRedes/07-ospf/04-areas-y-tipos-de-routers) · **Siguiente:** [6 · El coste OSPF](/ApuntesRedes/07-ospf/06-coste-ospf)