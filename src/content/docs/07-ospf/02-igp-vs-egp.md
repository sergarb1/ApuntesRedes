---
title: 2 — IGP vs EGP y RIP vs OSPF
...
- **OSPF mira el ancho de banda** y calcula un **coste** por enlace (lo verás en el [punto 6](/ApuntesRedes/07-ospf/06-coste-ospf)): puede elegir una ruta con más saltos si es por fibra. Y como todos los routers de un área conocen la topología completa, convergen mucho más rápido.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/07-ospf) · **Anterior:** [1 · De estático a dinámico](/ApuntesRedes/07-ospf/01-de-estatico-a-dinamico) · **Siguiente:** [3 · Conceptos OSPF](/ApuntesRedes/07-ospf/03-conceptos-ospf)