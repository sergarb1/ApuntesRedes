---
title: 1 — De estático a dinámico
...
**Analogía del GPS:** una ruta estática es como marcar en un mapa la ruta a mano y pegarla en el salpicadero: si cortan una carretera, sigues yendo a la calle cortada. El routing dinámico es el GPS en modo "recalcular": detecta el atasco y te reencamina al momento. Precisamente esa "recalculación" automática se llama **convergencia**, y la estudiarás con la comparativa del [punto 2](/ApuntesRedes/07-ospf/02-igp-vs-egp).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/07-ospf) · **Anterior:** [Índice de la unidad](/ApuntesRedes/07-ospf) · **Siguiente:** [2 · IGP vs EGP y RIP vs OSPF](/ApuntesRedes/07-ospf/02-igp-vs-egp)