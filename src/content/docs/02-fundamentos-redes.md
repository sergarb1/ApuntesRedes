---
title: U02 — Fundamentos de redes
description: La red mágica que no funciona 😵‍💫
---

<p><small>La red mágica que no funciona 😵‍💫</small></p>

> 🗺️ **El mapa del paquete:** 🚪 Bienvenida → **🌐 AQUÍ ESTÁS (U02)** → 📦 OSI → 🔌 Físico → 🧮 IPv4 → 🚀 IPv6 → 🔀 Switching → 🏢 VLAN → 🧭 Routing → 🗣️ OSPF → 🌐 NAT → 🩺 Diagnóstico → ☁️ Cloud

---

Bienvenido a la primera unidad de verdad. La Unidad 01 te dio la vuelta al castillo: ya sabes *de qué hablamos*. Ahora toca poner los cimientos: qué es una red en profundidad, cuáles son sus piezas, cómo se organizan los dispositivos y cómo se hablan entre sí. No se necesita experiencia previa; solo ganas de montar tu primera red.
...
|---|---|---|
| [01 · ¿Qué es una red?](/ApuntesRedes/02-fundamentos-redes/01-que-es-una-red) | Definición, los 4 componentes, cliente/servidor vs P2P | Todos |
| [02 · Tipos de red y alcance](/ApuntesRedes/02-fundamentos-redes/02-tipos-y-alcance) | PAN, LAN, CAN, MAN, WAN y criterios de clasificación | Todos |
| [03 · Topologías](/ApuntesRedes/02-fundamentos-redes/03-topologias) | Física vs lógica, estrella, bus, anillo, malla, árbol | Todos |
| [04 · Dispositivos de red](/ApuntesRedes/02-fundamentos-redes/04-dispositivos) | Hub, switch, router, AP, módem, firewall y su capa | Todos |
| [05 · El modelo OSI](/ApuntesRedes/02-fundamentos-redes/05-modelo-osi) | Por qué 7 capas, qué añade cada una, OSI vs TCP/IP | Todos |
...
- ¿Cero conocimientos? → Vuelve a la [Unidad 01](/ApuntesRedes/01-introduccion), te deja en la puerta de esta unidad.
- ¿Ya sabes lo básico? → Arranca directamente en el [punto 1](/ApuntesRedes/02-fundamentos-redes/01-que-es-una-red).

**📍 Primer punto:** [01 · ¿Qué es una red?](/ApuntesRedes/02-fundamentos-redes/01-que-es-una-red)  
**⏭️ Al acabar la unidad, continúa en [U03 · Modelos OSI y análisis](/ApuntesRedes/03-modelos-osi-analisis).**