...
> 🗺️ **Estás en:** 🔀 U07 → 01 · ¿Qué es un switch?
...
Recuerda el reparto de poderes: si la decisión se toma con **IP**, el dispositivo es un **router** (capa 3). El switch vive un piso más abajo, en el mundo de las MACs. Cuando llegues a la [U08 de VLANs](/ApuntesRedes/08-vlans) verás que hasta los switches pueden "subir de piso" cuando trabajan en capa 3, pero eso es otro capítulo.
...
Ese "inundar" (*flooding*) no es una chapuza: es un mecanismo de aprendizaje. Al inundar, el destino acaba respondiendo, y su respuesta permite al switch aprender dónde vive. Lo estudiamos al detalle en el [siguiente punto](/ApuntesRedes/07-switching-stp/02-aprendizaje-mac).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/07-switching-stp) · **Anterior:** [Índice de la unidad](/ApuntesRedes/07-switching-stp) · **Siguiente:** [02 · Aprendizaje de MACs](/ApuntesRedes/07-switching-stp/02-aprendizaje-mac)