...
> 🗺️ **Estás en:** 🔀 U07 → 07 · RSTP y PortFast
...
> 💡 **errdisable:** cuando un puerto entra en errdisable se desactiva automáticamente. Para recuperarlo: `shutdown` + `no shutdown`, o configurar recuperación automática con `errdisable recovery`. Lo vemos de nuevo en el [punto 8](/ApuntesRedes/07-switching-stp/08-port-security).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/07-switching-stp) · **Anterior:** [06 · Puertos y estados STP](/ApuntesRedes/07-switching-stp/06-puertos-y-estados-stp) · **Siguiente:** [08 · Port Security](/ApuntesRedes/07-switching-stp/08-port-security)