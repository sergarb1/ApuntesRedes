...
> 🗺️ **Estás en:** 🔀 U07 → 06 · Puertos y estados STP
...
**Tiempo total de convergencia STP: 30-50 segundos.** ¡Una eternidad en redes modernas! Si un PC se conecta a un puerto sin protección, tardará hasta 50 segundos en poder hablar. Por eso existen PortFast y RSTP, que verás en el [punto 7](/ApuntesRedes/07-switching-stp/07-rstp-y-portfast).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/07-switching-stp) · **Anterior:** [05 · STP: fundamentos](/ApuntesRedes/07-switching-stp/05-stp-fundamentos) · **Siguiente:** [07 · RSTP y PortFast](/ApuntesRedes/07-switching-stp/07-rstp-y-portfast)