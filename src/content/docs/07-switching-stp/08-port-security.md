...
> 🗺️ **Estás en:** 🔀 U07 → 08 · Port Security
...
Es la respuesta al ataque de CAM flooding del [punto 2](/ApuntesRedes/07-switching-stp/02-aprendizaje-mac): si limitas las MACs por puerto, un atacante no puede llenar la tabla CAM ni conectar dispositivos no autorizados.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/07-switching-stp) · **Anterior:** [07 · RSTP y PortFast](/ApuntesRedes/07-switching-stp/07-rstp-y-portfast) · **Siguiente:** [09 · Cierre](/ApuntesRedes/07-switching-stp/09-cierre)