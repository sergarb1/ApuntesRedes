...
> 🗺️ **Estás en:** 🔀 U07 → 03 · Dominios de colisión y broadcast
...
> ⚠️ **Trampa clásica:** un switch conectado a otro switch NO crea un dominio de broadcast nuevo: siguen siendo uno solo. Solo el router (o un switch de capa 3 con SVIs, como verás en la [U08](/ApuntesRedes/08-vlans)) divide dominios de broadcast.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/07-switching-stp) · **Anterior:** [02 · Aprendizaje de MACs](/ApuntesRedes/07-switching-stp/02-aprendizaje-mac) · **Siguiente:** [04 · La tormenta de broadcast](/ApuntesRedes/07-switching-stp/04-tormenta-de-broadcast)