...
> 🗺️ **Estás en:** 🚪 **Unidad 01** → 01 · ¿Qué es una red?
...
Ejemplo real: cuando abres `google.com`, **tu ordenador es el cliente** y el servidor de Google es el **servidor**. El cliente pide la página; el servidor la envía. Esa pareja *pido-entrego* se llama **arquitectura cliente-servidor** y domina casi todas las redes de verdad (la alternativa punto a punto la verás en la U02).
...
> 📌 **No hace falta memorizar aún las siglas.** Con que hoy te quede claro que existen distintos tamaños y que Internet es la mayor red WAN imaginable, es suficiente. En la U02 las veremos todas en detalle.
...
📚 [Volver al índice de la Unidad 01](/ApuntesRedes/01-introduccion) · **Siguiente:** [02 · Términos que no se ven](/ApuntesRedes/01-introduccion/02-terminos-basicos)