...
> 🗺️ **Estás en:** 🚪 **Unidad 01** → 04 · Las herramientas del oficio
...
5. Repite el ejercicio con otro PC más (PC2 → `192.168.0.3`) y fíjate en lo que cambia: ahora el switch decide a qué puerto enviar cada sobre. Ya has visto, en miniatura, todo lo que harás en la U07.
</details>
...
📚 [Volver al índice de la Unidad 01](/ApuntesRedes/01-introduccion) · **Siguiente:** [05 · La mente de un administrador](/ApuntesRedes/01-introduccion/05-metodo-diagnostico)