...
description: Todas las palabras de la Unidad 01 y las dudas que nadie se atreve a decir en voz alta 😅
---

<p><small>Todas las palabras de la Unidad 01 y las dudas que nadie se atreve a decir en voz alta 😅</small></p>

> 🗺️ **Estás en:** 🚪 **Unidad 01** → 06 · Glosario y preguntas tontas

---

## 📖 Glosario de la A a la Z

Esta es la "chuleta final" de la Unidad 01. Cada término con su idea en una frase y una analogía corta para que se te pegue. No la memorices: **vuelve aquí cuando una palabra te atraviese el techo**, y sigue con lo tuyo.
...
Todo esto lo abres en la **U04** con crimpadora en mano.
...
> **Caja:** — «¿Y qué empieza?»
>
> **Switch:** — «La U02, caja. La U02. Y si te crees grande, aún no has visto lo que es una red *bien* administrada.»

Se apaga todo: **la Unidad 01 se acaba aquí, y en la próxima página empieza el viaje de verdad.**

> **PRÓXIMAMENTE EN U02: · Fundamentos de redes — tipos de redes, topologías y el primer switch de verdad, con CONRAD en plena forma y en modo "te lo dije".** 🚪→🌐
...
| Lo que te llevas de la Unidad 01 | Para qué te servirá desde ya |
|---|---|
| El vocabulario (IP, MAC, paquete, protocolo…) | Hablar el idioma del curso desde la primera clase |
| Packet Tracer instalado y probado | Montar tu primera red en la U02 sin miedo |
...
📚 [Volver al índice de la Unidad 01](/ApuntesRedes/01-introduccion) · **Siguiente:** [U02 · Fundamentos de redes](/ApuntesRedes/02-fundamentos-redes)