...
📚 [Volver al índice de la unidad](/ApuntesRedes/05-trunking-inter-vlan) · **Anterior:** [2 · Configuración y verificación de trunks](/ApuntesRedes/05-trunking-inter-vlan/02-configuracion-y-verificacion) · **Siguiente:** [4 · Switch capa 3 y SVIs](/ApuntesRedes/05-trunking-inter-vlan/04-switch-capa3)