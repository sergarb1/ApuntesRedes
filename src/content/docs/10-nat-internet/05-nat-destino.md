...
> 🗺️ **Estás en:** 🌐 U10 → 05 · NAT destino (port forwarding)
...
📚 [Volver al índice de la unidad](/ApuntesRedes/10-nat-internet) · **Anterior:** [04 · PAT (sobrecarga)](/ApuntesRedes/10-nat-internet/04-pat) · **Siguiente:** [06 · Tabla NAT y verificación](/ApuntesRedes/10-nat-internet/06-tabla-nat-y-verificacion)