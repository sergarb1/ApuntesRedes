...
> 🗺️ **Estás en:** 🌐 U10 → 06 · Tabla NAT y verificación
...
> ⚠️ **Síntoma clásico:** la tabla NAT vacía a pesar del tráfico. Suele significar que falta `ip nat inside` / `ip nat outside` en las interfaces, o que la access-list no coincide con la red. Es el fallo que protagoniza el [⚡ Laboratorio de Tortura del cierre](/ApuntesRedes/10-nat-internet/09-head-first) y el boletín avanzado.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/10-nat-internet) · **Anterior:** [05 · NAT destino (port forwarding)](/ApuntesRedes/10-nat-internet/05-nat-destino) · **Siguiente:** [07 · Problemas y soluciones](/ApuntesRedes/10-nat-internet/07-problemas-y-soluciones)