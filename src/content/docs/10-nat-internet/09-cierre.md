...
Has terminado la teoría. Este cierre es el aterrizaje: recorres lo aprendido con juegos, un laboratorio real de NAT en Packet Tracer y las preguntas que te harán en una entrevista. Léelo justo después del [punto 8](/ApuntesRedes/10-nat-internet/08-configuracion-completa) y antes de abrir los boletines.
...
> **Pista para el diagnóstico:** si el ping al gateway (192.168.1.1) funciona pero el ping a 8.8.8.8 no, y la tabla NAT está vacía, el problema está en la marca de interfaces. Es el fallo estrella de esta unidad: el que debes saber cazar en el [boletín avanzado](/ApuntesRedes/boletines/boletin-u10-avanzado).
...
**PRÓXIMAMENTE EN U11:** *Diagnóstico y monitorización. Troubleshooting, Wireshark, SNMP, y la habilidad más importante: saber por qué algo no funciona. Porque el NAT que acabas de configurar... algún día fallará.*
...
📚 [Volver al índice de la unidad](/ApuntesRedes/10-nat-internet) · **Anterior:** [08 · Configuración completa](/ApuntesRedes/10-nat-internet/08-configuracion-completa) · **Siguiente:** **[U11 · Diagnóstico y monitorización](/ApuntesRedes/11-diagnostico-monitorizacion)**