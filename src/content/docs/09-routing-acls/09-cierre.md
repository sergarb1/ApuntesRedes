...
**PRÓXIMAMENTE EN U10:** El salto al routing dinámico: los routers dejarán de esperar a que escribas cada ruta y empezarán a hablar entre ellos. OSPF barre el mapa de la red, descubre los caminos, y la convergencia es cosa de segundos. ¿Será la ruta dinámica tan lista como presume? 🗣️
...
📚 [Volver al índice de la unidad](/ApuntesRedes/09-routing-acls) · **Anterior:** [08 · ACL extendida y nombrada](/ApuntesRedes/09-routing-acls/08-acl-extendida-y-nombrada) · **Siguiente:** **[U10 · Routing dinámico](/ApuntesRedes/10-routing-dinamico)**