...
Ese "inundar" (*flooding*) no es una chapuza: es un mecanismo de aprendizaje. Al inundar, el destino acaba respondiendo, y su respuesta permite al switch aprender dónde vive. Lo estudiamos al detalle en el [siguiente punto](/ApuntesRedes/04-switching/02-aprendizaje-mac).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/04-switching) · **Anterior:** [Índice de la unidad](/ApuntesRedes/04-switching) · **Siguiente:** [2 · Aprendizaje de MACs](/ApuntesRedes/04-switching/02-aprendizaje-mac)