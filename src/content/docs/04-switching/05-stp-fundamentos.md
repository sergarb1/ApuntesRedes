...
Estos valores los usarás en el [boletín avanzado](/ApuntesRedes/boletines/boletin-u04-avanzado) para calcular qué camino elige STP.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/04-switching) · **Anterior:** [4 · La tormenta de broadcast](/ApuntesRedes/04-switching/04-tormenta-de-broadcast) · **Siguiente:** [6 · Puertos y estados STP](/ApuntesRedes/04-switching/06-puertos-y-estados-stp)