...
> 🗺️ **Estás en:** ☁️ U12 → 06 · Cloud networking
...
- Los **servidores internos** (bases de datos, backend) están en la subnet privada: no tienen IP pública y su única salida a Internet es el **NAT Gateway**, que hace **PAT** (el mismo NAT de la U10, pero gestionado).
...
📚 [Volver al índice de la unidad](/ApuntesRedes/12-cloud-virtualizacion-futuro) · **Anterior:** [05 · NFV](/ApuntesRedes/12-cloud-virtualizacion-futuro/05-nfv) · **Siguiente:** [07 · IoT, 5G y edge computing](/ApuntesRedes/12-cloud-virtualizacion-futuro/07-iot-5g-y-edge)