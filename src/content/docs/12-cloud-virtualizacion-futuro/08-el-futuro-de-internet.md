...
> 🗺️ **Estás en:** ☁️ U12 → 08 · El futuro de Internet
...
**IPv6** (U05) resolvió el problema más urgente: el **agotamiento de direcciones** (128 bits, autoconfiguración, sin NAT). Pero hay problemas que IPv6 no toca:
...
Es exactamente el debate de la U05 y de la entrevista: **¿IPv6 es suficiente o necesitamos otra Internet?** No hay respuesta única; este punto te da las cartas para argumentar.
