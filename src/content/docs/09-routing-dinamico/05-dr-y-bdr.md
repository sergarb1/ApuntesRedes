...
> 🗺️ **Estás en:** 🗣️ **U09 · Routing dinámico OSPF** → 05 · DR y BDR
...
En `show ip ospf neighbor` (lo usarás en el [punto 7](/ApuntesRedes/09-routing-dinamico/07-configuracion-ospf) y en los boletines) verás dos estados que hay que saber leer:
...
📚 [Volver al índice de la unidad](/ApuntesRedes/09-routing-dinamico) · **Anterior:** [04 · Áreas y tipos de routers](/ApuntesRedes/09-routing-dinamico/04-areas-y-tipos-de-routers) · **Siguiente:** [06 · El coste OSPF](/ApuntesRedes/09-routing-dinamico/06-coste-ospf)