...
Con **MANO** puedes encadenar servicios: un firewall VNF → un load balancer VNF → un router VNF, todo desplegado y escalado con una sola petición. Es exactamente lo que el [punto 6](/ApuntesRedes/13-cloud-virtualizacion-futuro/06-cloud-networking) hace en el plano de red, pero aplicado a los servicios.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/13-cloud-virtualizacion-futuro) · **Anterior:** [04 · SDN](/ApuntesRedes/13-cloud-virtualizacion-futuro/04-sdn) · **Siguiente:** [06 · Cloud networking](/ApuntesRedes/13-cloud-virtualizacion-futuro/06-cloud-networking)