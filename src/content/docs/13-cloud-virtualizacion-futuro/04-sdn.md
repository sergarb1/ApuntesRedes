...
Y un apunte importante: SDN no es "una cosa de laboratorio". Es el modelo que está detrás de los **datacenters cloud** y del **core de 5G** (lo verás en [el punto 7](/ApuntesRedes/13-cloud-virtualizacion-futuro/07-iot-5g-y-edge)). La nube de los puntos 1-3 no se entiende sin este salto conceptual.
...
En resumen: SDN no es "mejor" o "peor" que la red tradicional — es **otra forma de operar**, más programable y observable, con un coste: la disponibilidad del controlador. El [Fireside del cierre](/ApuntesRedes/13-cloud-virtualizacion-futuro/09-cierre) debate exactamente esta tensión.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/13-cloud-virtualizacion-futuro) · **Anterior:** [03 · Docker networking](/ApuntesRedes/13-cloud-virtualizacion-futuro/03-docker-networking) · **Siguiente:** [05 · NFV](/ApuntesRedes/13-cloud-virtualizacion-futuro/05-nfv)