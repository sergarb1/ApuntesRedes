...
> 🗺️ **Estás en:** ☁️ U13 → 02 · Virtualización de redes
...
En [el punto 1](/ApuntesRedes/13-cloud-virtualizacion-futuro/01-modelos-cloud) alquilabas VMs por Internet. Esta es la tecnología que lo hace posible: un **hypervisor** que reparte el hardware entre varias máquinas, y unos **switches virtuales** que las conectan sin un solo cable. Todo lo que sabes de la asignatura —IP, switches, VLANs, routing— existe ahora también en versión software.
...
- Para aislar grupos de VMs se usan **VLANs** (recuerda la U08): el vSwitch etiqueta las tramas con 802.1Q.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/13-cloud-virtualizacion-futuro) · **Anterior:** [01 · Modelos cloud](/ApuntesRedes/13-cloud-virtualizacion-futuro/01-modelos-cloud) · **Siguiente:** [03 · Docker networking](/ApuntesRedes/13-cloud-virtualizacion-futuro/03-docker-networking)