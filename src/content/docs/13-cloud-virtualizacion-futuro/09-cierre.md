...
> 🗺️ **Estás en:** ☁️ U13 → 09 · Cierre

---

Has terminado la teoría. Este cierre es el aterrizaje: recorre todo lo aprendido con juegos, un laboratorio real con Docker y las preguntas que te harán en una entrevista. Y esta vez no es un cierre cualquiera: es el **cierre de la asignatura**. Has seguido al paquete desde que nace en un navegador (U02) hasta la nube y el futuro de Internet. Léelo justo después del [punto 8](/ApuntesRedes/13-cloud-virtualizacion-futuro/08-el-futuro-de-internet) y antes de abrir los boletines.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/13-cloud-virtualizacion-futuro) · **Anterior:** [08 · El futuro de Internet](/ApuntesRedes/13-cloud-virtualizacion-futuro/08-el-futuro-de-internet) · **Siguiente:** *(fin de la asignatura)*
