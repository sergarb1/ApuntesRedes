...
> 🗺️ **Estás en:** ☁️ U13 → 07 · IoT, 5G y edge computing
...
Hoy hay más dispositivos que direcciones IPv4 en el mundo. Cuando cada sensor, bombilla y grúa de obra necesita IP, la respuesta no es NAT en cascada: es **IPv6**, con sus 128 bits (recuerda la U06). Algunas consecuencias prácticas:
...
Es la combinación exacta de [punto 4 (SDN)](/ApuntesRedes/13-cloud-virtualizacion-futuro/04-sdn) y [punto 5 (NFV)](/ApuntesRedes/13-cloud-virtualizacion-futuro/05-nfv), aplicada a la telefonía.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/13-cloud-virtualizacion-futuro) · **Anterior:** [06 · Cloud networking](/ApuntesRedes/13-cloud-virtualizacion-futuro/06-cloud-networking) · **Siguiente:** [08 · El futuro de Internet](/ApuntesRedes/13-cloud-virtualizacion-futuro/08-el-futuro-de-internet)