...
> 🗺️ **Estás en:** ☁️ U13 → 03 · Docker networking
...
Por dentro, Docker usa **pares veth**: un extremo virtual dentro del contenedor y otro en el puente del host. Es exactamente el mismo concepto de NIC virtual que viste con el vSwitch en [el punto 2](/ApuntesRedes/13-cloud-virtualizacion-futuro/02-virtualizacion-de-redes), pero aplicado a procesos.
...
📚 [Volver al índice de la unidad](/ApuntesRedes/13-cloud-virtualizacion-futuro) · **Anterior:** [02 · Virtualización de redes](/ApuntesRedes/13-cloud-virtualizacion-futuro/02-virtualizacion-de-redes) · **Siguiente:** [04 · SDN](/ApuntesRedes/13-cloud-virtualizacion-futuro/04-sdn)