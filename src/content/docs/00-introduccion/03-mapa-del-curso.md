...
> 🗺️ **Estás en:** 🚪 **Tema 0** → 03 · El mapa del curso
...
Antes de escribir una sola línea de configuración, vas a ver el plano completo: **dónde estás, qué paradas hay y qué vas a saber hacer al bajarte de cada una**. Así, cuando estés en la U04 calculando subredes, sabrás exactamente para qué lo estás haciendo.
...
|---|---|---|---|
| 0 | 🚪 **Tema 0 · Bienvenida** | Hablar el idioma básico de las redes y tener las herramientas listas | Nada: esta es la puerta de entrada |
| 1 | 🌐 **U01 · Fundamentos de redes** | Distinguir tipos de redes, topologías y dispositivos, y montar una red sencilla | El Tema 0 |
...
| 9 | 🗣️ **U09 · Routing dinámico (OSPF)** | Dejar que los routers se hablen entre ellos y elijan la mejor ruta | Routing y ACLs (U08) |
| 10 | 🌍 **U10 · NAT y acceso a Internet (DHCP)** | Dar salida a Internet a una red privada y repartir IPs automáticamente | Subredes (U04) y routing (U08-U09) |
| 11 | 🩺 **U11 · Diagnóstico y monitorización (SNMP)** | Cazar averías con método y vigilar la red como un NOC | Ping y método del Tema 0, más IP (U04) |
| 12 | ☁️ **U12 · Cloud, virtualización y futuro** | Situar el oficio en la nube y saber hacia dónde camina la profesión | Todo el curso, sobre todo U10 y U11 |

> 📌 **Cómo leer la tabla:** cada fila solo tiene sentido si has hecho la de arriba. Es la "escalera" del curso: si te saltas un peldaño, el siguiente te va a costar el doble. El Tema 0 (estas páginas) es el vestíbulo: sin él, la U01 te sonaría a chino.
...
|---|---|---|
| **Tema 0** | El vestíbulo que estás cruzando ahora mismo | Antes de cada unidad, para refrescar vocabulario y método |
...
|---|---|---|
| U05 · IPv6 | U04 · IPv4 | IPv6 se entiende comparándolo con su hermano mayor |
| U07 · VLANs | U06 · Switching | Una VLAN se monta sobre la lógica del switch |
| U09 · OSPF | U08 · Routing | El enrutamiento dinámico amplía el estático, no lo reemplaza sin más |
| U10 · NAT | U04 + U08 | Se necesita saber qué subredes usas para poder disfrazarlas |
| U11 · Diagnóstico | Tema 0 y U04 | La escalera del ping pide saber qué IPs está pidiendo |
| U12 · Cloud | U10 y U11 | La nube se describe con NAT, routing y monitorización |
...
|---|---|---|
| 🏗️ **Montar redes LAN seguras** | U01 → U07 | De cero a una red local funcionando: dispositivos, cables, switching y VLANs |
| 🌍 **Unirlas al mundo** | U08 → U10 | Routers, rutas y NAT: tu red pequeña empieza a hablar con Internet |
| 🩺 **Gestionarlas** | U11 → U12 | Vigilar, diagnosticar y pensar en la red del futuro |

**Hito 1 (U01–U07).** Construimos desde los cimientos: qué es una red, por qué se organiza en capas, qué cables la sostienen, cómo se direccionan los paquetes y cómo los switches las mantienen ordenadas y separadas. Al terminar el hito serás capaz de **montar y dejar funcionando la red local de un centro educativo pequeño**, con sus equipos, su cableado y sus VLANs.

**Hito 2 (U08–U10).** Es el momento de abrir puertas: aprendemos a encaminar paquetes entre redes distintas (routing), a filtrar quién entra y quién sale (ACLs) y a conectar todo a Internet con una sola IP pública (NAT). Aquí tu "red de edificio" se convierte en "un ciudadano más del mundo".

**Hito 3 (U11–U12).** Una red montada necesita a alguien que la cuide: métodos de diagnóstico, monitorización con SNMP y, de propina, la mirada hacia la nube y la virtualización para que entiendas dónde estás pisando en el futuro.
...
- **No hay VLANs sin switching.** Una VLAN se monta *sobre* un switch. Si no sabes qué hace un switch (U06), la VLAN (U07) es un acto de fe.
- **No hay routing sin IPs.** Enrutar es decidir por dónde va un paquete *según su dirección IP*. Si no dominas las subredes (U04), no hay nada que enrutar (U08).
- **No hay Internet sin NAT.** Tu red privada usa direcciones de casa; para salir al mundo necesita NAT (U10), que depende del routing (U08-U09) y de que entiendas qué es una IP pública.
...
2. Tres hitos: **montar** redes LAN seguras (U01-U07), **unirlas** al mundo (U08-U10) y **gestionarlas** (U11-U12).
...
📚 [Volver al índice del Tema 0](/ApuntesRedes/00-introduccion) · **Siguiente:** [04 · Las herramientas del oficio](/ApuntesRedes/00-introduccion/04-herramientas)