...
const unidadesExpandidas = {
  ...
  '02-ethernet-cableado': [
    ...
    { slug: '02-ethernet-cableado/08-trama-ethernet', label: '8 · La trama Ethernet' },
    { slug: '02-ethernet-cableado/09-cierre', label: '9 · Cierre' },
  ],
  '03-direccionamiento-ip': [
    { slug: '03-direccionamiento-ip/01-estructura-ipv4', label: '1 · Estructura de IPv4' },
