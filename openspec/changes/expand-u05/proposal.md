...
Tras las ampliaciones de U01, U02, U07 y U08, la U05 (`05-ipv6-transicion.md`) sigue el patrón antiguo: un único archivo que comprime teoría y secciones Head First. Incumple los estándares `contenido-unidad` y `contenido-boletin`.
...
- Se crea la subcarpeta `05-ipv6-transicion/` con **8 puntos de teoría ampliados** + **1 cierre Head First**, reutilizando el contenido factual actual (estructura, compresión, tipos, EUI-64, SLAAC/DHCPv6, ICMPv6/NDP, transición, configuración) y expandiéndolo con ejemplos resueltos.
- Cierre Head First con laboratorio Packet Tracer con fallo intencionado y "PRÓXIMAMENTE EN U06".
