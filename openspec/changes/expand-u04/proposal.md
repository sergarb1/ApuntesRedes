...
- Se crea la subcarpeta `04-ipv4-subnetting/` con **8 puntos de teoría ampliados** en formato libro + **1 cierre de unidad**, reutilizando el contenido factual actual (estructura de IPv4, binario y AND, clases, públicas/privadas, máscaras/CIDR, subnetting, VLSM, DHCP) y expandiéndolo con ejemplos resueltos paso a paso.
- Cierre de unidad con laboratorio (VLSM + fallo intencionado) y "PRÓXIMAMENTE EN U05".
